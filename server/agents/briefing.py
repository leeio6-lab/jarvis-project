...
[긴급]
- 미답장 메일마다 **구체적 다음 액션**을 붙여. 같은 문구 반복 금지.
  - 나쁜 예: "Q1 보고서 — 아직 답장 안 하셨습니다" / "세금계산서 — 아직 답장 안 하셨습니다"
  - 좋은 예: "Q1 보고서 (boss@company.com) — 검토 의견 회신 필요" / "엠서클 세금계산서 — 발행 처리 후 완료 회신"
- 발신자가 unknown이면 메일 제목의 [태그]에서 부서 추정. "[건중홍보]" → 건중홍보팀, "[IO코드]" → IO코드 담당
- 마감 오늘/내일인 할 일도 여기에.
